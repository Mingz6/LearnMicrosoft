# From https://www.customvision.ai/

$predictionUrl="<https://uofccustomvision-prediction.cognitiveservices.azure.com/customvision/v3.0/Prediction/3f9e1db4-2b21-4f79-b8a0-a2194792f82a/classify/iterations/AnimalPrediction/url>"
