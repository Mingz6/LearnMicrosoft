# https://language.cognitive.azure.com/clu/projects

$endpointUrl="<https://uofc.cognitiveservices.azure.com/language/:analyze-conversations?api-version=2022-10-01-preview>"
$key = "<key>"
$projectName = "<uofclanguage>"
$deploymentName = "<automationdeployment>"
